...
export default class Editor extends Component {
    ...
    login(passw) {
        if(passw.length > 5) {
            axios
                .post("./api/login.php", {"password": passw})
                .then(res => {
                    this.setState({
                        auth: res.data.auth,
    ...
    open(page, callback) {
        this.currentPage = page; //not working
        axios
            ...
            .then(() => this.iframe.load("../yfuy1g221ub_hhg44.html")) //чтобы не попасть
    ...
    render() {
        ...
        return (
            <>
                ...
                <Panel virtualDom={this.virtualDom}/>
                ...
                <ConfirmModal 
                    ...
                    text={{
                        title: "Сохранение",
                        descr: "Вы дествительно хотите сохранить изменения?",
                        btn: "Опубликовать"
                    }}/>
                ...
                <ConfirmModal 
                    ...
                    text={{
                        title: "Выход",
                        descr: "Вы дествительно хотите выйти?",
                        btn: "Выйти"
                    }}/>
